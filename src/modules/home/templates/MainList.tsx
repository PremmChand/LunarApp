import { ActivityIndicator, Platform, RefreshControl, StyleSheet, Text, View, type NativeScrollEvent, type NativeSyntheticEvent } from 'react-native'
import React, { use, useRef, useState, type FC } from 'react'
import { dynamicDashboardData as fullData } from '@utils/db'
import { FlatList } from 'react-native';
import { setLoading } from '../api/slice';
...
import AimatedHorizontalList from '../organisms/AimatedHorizontalList';
...
const sectionComponents: { [key:string]: React.ComponentType<any> } ={
    ...
    animated_horizontal_list: AimatedHorizontalList,
}
